...
public class CreateNewProgressTestCase extends TestCase {
	...
	public void run() throws MalformedURLException, IOException, InterruptedException {
		...
		setTestCaseID(9);
		setTestCaseTitle("Create New Progress Test");
		setTestCaseDescription("Creating new ProgressTest with random credentials");
		...
		subjectsController.createNewProgressTest(qaDriver);
	...
	public static void main(String[] args)
		...
		new CreateNewProgressTestCase().run();
	}
}
